...
app.get("/build", function(req, res){
	...
	var requiredModules = req._parsedUrl.query.split(",");
	//Create the module exports requirements 	
	...
	//Create a temp file listing the module exports
...
var allModules = getDirectories('../node_modules');
var turfModules =[];
